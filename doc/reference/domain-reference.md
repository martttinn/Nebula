...
- los canales comerciales reales versionados hoy son email directo a `hola@somosnebula.com` y teléfono `+34 622 028 550`; no existe todavía formulario, calendario ni backend de captación
- el footer puede exponer canales sociales versionados como salidas externas, pero no debe presentarlos como formulario, soporte ni flujo de captación conectado
- mientras la página de contacto no exista, el ancla `#contacto` puede resolver la última card de `testimonials`, y su botón principal puede abrir `mailto:hola@somosnebula.com` siempre que no prometa formulario, calendario ni automatización conectada
...
- **Preparación de contacto**: la web debe acercar al visitante al siguiente paso sin inventar una integración comercial avanzada que todavía no existe; hoy ese paso termina en la última card de `testimonials`, recogida por `#contacto`, con salida directa por email y datos de contacto visibles en el footer, sin página ni formulario conectados
...
- interpretar la última card de `testimonials` como formulario, calendario o automatización de captación cuando hoy solo abre el email directo confirmado
...
- canal comercial real por email: `hola@somosnebula.com`
- canal comercial real por teléfono: `+34 622 028 550`
- canales sociales visibles en footer: Instagram y LinkedIn
- formulario, calendario o CRM de captación: `pendiente`
